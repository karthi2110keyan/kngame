...
const player = new gameFunction({
  ...
  Imagesrc:"./sky/_Idle.png",
    ...
    sprites:{
        ...
        run:{
            Imagesrc:"./sky/_Run.png",
            spriteWidth:1200,
            frameMax:10,
        }, idleleft:{
            Imagesrc:"./sky/_Idleleft.png",
            spriteWidth:1200,
            frameMax:10,
        },
        runleft:{
            Imagesrc:"./sky/_Runleft.png",
            spriteWidth:1200,
            frameMax:10,
        },
        jump:{
            Imagesrc:"./sky/_Jump.png",
            spriteWidth:360,
            frameMax:3,
        },fall:{
            Imagesrc:"./sky/_Fall.png",
            spriteWidth:360,
            frameMax:3,
        },attack:{
            Imagesrc:"./sky/attack.png",
            spriteWidth:1200,
            frameMax:10,
        }
    }
